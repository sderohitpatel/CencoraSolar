          ...
          <div class="section-body">
            ...
            <div class="row mt-4">
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        <form action="{{route('book-product-update', $product->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{-- @method('PUT') --}}
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <label>{{__('admin.Existing Book Cover')}}</label>
                                    <div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" name="author" class="form-control" value="{{$product->author_name}}">
                                </div>

                                <div class="form-group col-12">
                                    <label>{{__('admin.Book Tilte')}} <span class="text-danger">*</span></label>
                                    <input type="text" id="name" name="book_title" class="form-control" value="{{$product->book_title}}">
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="author_bio" id="" cols="30" rows="10" class="summernote">{{html_decode($product->author_bio)}}</textarea>
                                </div>
                                <div class="form-group col-12">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="makes_book_suitable" id="" cols="30" rows="10" class="summernote">{{html_decode($product->makes_book_suitable)}}</textarea>
                                </div>
                                <div class="form-group col-12">
                                    <label>{{__("admin.Book's Trailer")}}<span> (<b>{{__('user.Only Video file allowed')}}</b>)</span></label>
                                    <input name="book_trailer_video" accept="video/*" type="file" class="form-control" value="{{$product->book_trailer_video}}">
                                ...
                                <div class="form-group col-12">
                                    <label>{{__('admin.Highlight')}}<b style="font-size:13px">( Note: Please contact admin to update this field)</b></label>
                                    <div>
