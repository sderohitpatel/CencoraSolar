          ...
          <div class="section-body">
            ...
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        <form action="{{ route('store-script-type-product') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">

                                <input type="hidden" name="product_type" value="{{ $product_type }}">
                                <div class="form-group col-12">
                                    <label>{{__('admin.Upload Poster')}} <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" id="name" name="script_title" class="form-control" value="{{ old('script_title') }}">
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="writer_bio" id="" cols="30" rows="10" class="summernote">{{ old('writer_bio') }}</textarea>
                                </div>
                                <div class="form-group col-12">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="makes_script_suitable" id="" cols="30" rows="10" class="summernote">{{ old('makes_script_suitable') }}</textarea>
                                </div>
                                <div class="form-group col-12">
                                    <label>{{__("admin.Video Trailer")}}<span> (<b>{{__('user.Only Video file allowed')}}</b>)</span></label>
                                    <input name="video_trailer" accept="video/*" type="file" class="form-control" >
                                </div>
                                <div class="form-group col-12">
